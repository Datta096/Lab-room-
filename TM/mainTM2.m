...
load ThrPhs_MoI-1550_v-0_h-820_htacd.mat

load ThrPhs_MoI-1550_v-0_h-820_TA.mat
...
hold on
plot(data3(:,1),data3(:,8)-2935,'b*-')
plot(t3D,-sol3D(:,2)*m2ft,'g*-')
grid on
...
plot(t3D,sol3D(:,5)*100/omg_i,'g*-')
grid on
set(gca,'FontName','Lucida Sans','FontSize',12)
xlabel('Time (in sec)', 'FontSize',14)
title('omega (in %)', 'FontSize',14)
% nexttile
% % plot(tsp1, (Xsol(:,7)/d2r+8.4)*100/18, 'r*-')
% hold on
