...
z_i =820; % Set the initial altitude here, in feet
...
% Gsol1P(end) = 15;
D = Dmat(nd - 1);
[sol1P,~,flg1P] = fmincon(@costSSAR, Gsol1P, [],[],[],[], lb1, ub1, ...
...
if toSave == 1
    ...
    fname = ['ThrPhs_MoI-',num2str(heli.rotor.MoI),'_v-',num2str(u_i),'_h-',num2str(z_i),'_TA.mat'];
